	...
	<body>
		...
		<div id="container">
			...
			<div id="container-inside">
				<div id="text">
					<h3>ห้องสมุด</h3>
					<p>มหาวิทยาลัยธรรมศาสตร์ศูนย์พัทยามีหนังสือมากกว่า1000เล่มให้ได้เลือกอ่านกัน โดยทุกคนที่เข้ามาที่นี่สามารถเข้าไปใช้บริการได้โดยไม่เสียค่าใช้จ่ายใดๆทั้งสิ้น เพียงแต่ไม่มีสิทธิ์ยืมหนังสือออกนอกห้องสมุด</p>
					<div>
						<img src="img/library2.jpg" width="700px" height="400px">
					</div>
					<h3>กฏการใช้ห้องสมุด</br></h3>
					<p>1.งดนำอาหารและเครื่องดื่มเข้ามา</br>
					2.โปรดงดใช้เสียงดังรบกวนผู้อื่น</br>
					3.ผู้ที่จะยืมหนังสือได้ต้องเป็นคนที่มีบัตรนักศึกษาเท่านั้น </br></p>
				</div>
				<div id="menubar">
