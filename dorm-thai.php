...
<html>
	<head>
		<title>History</title>
		<meta charset="utf-8">
		<?php echo '<link rel="stylesheet" type="text/css" href="dorm-thai.css">'; ?>
	...
	<body>
				...
				<div id = "header-inner">
					...
					<nav>
						...
						<ul>
							...
							<a href="dorm-eng.php"><img src="img/uk.jpg" alt="thai" width="40px" height="20px" class="flag"></a>
		...
		<div id="container">
			<div>
				<img src="img/dormitory1.jpg" width="100%">
			</div>
			<div id="container-inside">
				<div id="text">
					<h3>หอพัก</h3>
					<p>หอพักนักศึกษามีสองหอคือสองหอ ได้แก่ หอชายและหอหญิง</br>โดยหอนึงมีห้องพักทั้งหมด24ห้อง แต่ละห้องนักศึกษาต้องอยู่ด้วยกันสองคน</br>ค่าใช้จ่าย ห้องนึงคือ15000บาท/เทอม ค่าน้ำค่าไฟจะมีบิลมาส่งให้ทุกเดือน</p>
					<div>
				...
				<div id="menubar">
					...
					<div class="menubar-inner">
						<i class="fa fa-tv" style="font-size:24px"></i> ห้องสมุด
					</div>
					</a>
				</div>
			</div>
